...
export default function AiWidget() {
    ...
    const [messages, setMessages] = useState<{role: 'user' | 'assistant', content: string}[]>([
        { role: 'assistant', content: 'Привет! Я ИИ-ассистент CyberWhale. Решаешь CTF или застрял на курсе? Спрашивай!' }
    ]);
            ...
            >
                {isOpen ? (
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.76c0-1.634.908-3.084 2.215-3.832V6a2.25 2.25 0 012.25-2.25h10.5A2.25 2.25 0 0119.5 6v2.928c1.307.748 2.215 2.198 2.215 3.832v3.75c0 1.634-.908 3.085-2.215 3.832v1.5a2.25 2.25 0 01-2.25 2.25H6.75a2.25 2.25 0 01-2.25-2.25v-1.5c-1.307-.747-2.215-2.198-2.215-3.832v-3.75z" />
